...
public class Principal {
	...
	private static EstudianteNotas añadirNota(EstudianteNotas[] estudiantes) throws NumberFormatException, IOException {
		...
		for(int i = 0; i < estudiantes.length; i++) {
			...
			if(estudiantes[i].getId() == idABuscar) {
				
				return estudiantes[i].añadirNotas();
	...
	public static void main(String[] args) throws IOException {
		...
		EstudianteNotas[] estudiantes = new EstudianteNotas[3];
